...
try {
    ...
    $sql = "select `song_name`
    from `total_station_music_library`,`myfavorite`,`MEMBER`,`entries`
    where  `MEMBER`.mem_no=myfavorite.`mem_no` and total_station_music_library.song_no=myfavorite.song_no and `entries`.entries_name=total_station_music_library.song_name;";
